...
import { cn } from "@/lib/presentation/components/utils"
...
import {
  ...
  SheetHeader,
  SheetTitle,
} from "@/lib/presentation/components/ui/sheet"
...
import {
  ...
  TooltipProvider,
  TooltipTrigger,
} from "@/lib/presentation/components/ui/tooltip"
...
function SidebarProvider({
  ...
  // Read the sidebar state from cookies after mount (client-side only)
  React.useEffect(() => {
    if (typeof document !== 'undefined') {
      const cookies = document.cookie.split('; ')
      const sidebarCookie = cookies.find(cookie => cookie.startsWith(`${SIDEBAR_COOKIE_NAME}=`))
      if (sidebarCookie) {
        const cookieValue = sidebarCookie.split('=')[1] === 'true'
